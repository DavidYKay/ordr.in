// <copyright file="UserOrder.cs" company="Lexsoft.fr">Copyright (c) 2014 All Rights Reserved</copyright>
namespace Lyglr.Ordrin.Contracts.Order
{
    using Newtonsoft.Json;

    /// <summary>
    /// Represents a user order using non-saved info.
    /// </summary>
    public class UserOrder : UserBaseOrder
    {
        /// <summary>
