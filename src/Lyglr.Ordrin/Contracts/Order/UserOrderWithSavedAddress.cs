// <copyright file="UserOrderWithSavedAddress.cs" company="Lexsoft.fr">Copyright (c) 2014 All Rights Reserved</copyright>
...
namespace Lyglr.Ordrin.Contracts.Order
{
    ...
    /// <summary>
    /// Represents an order using a saved address.
    /// </summary>
    public class UserOrderWithSavedAddress : UserBaseOrder
    {
        /// <summary>
        ...
        [JsonProperty("card_bill_addr2", Order = 11)]
